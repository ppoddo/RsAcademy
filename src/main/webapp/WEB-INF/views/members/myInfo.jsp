			...
			<table class="table2">
				...
				<tr>
					<td class="tableLable"><lable>비밀번호 </lable></td>
               		<td><input type="password" class="tableInput" id="pwd" name ="mbPwd" value="${loginUser.mbPwd}"> <span id="pwd-warn"></span></td>
				</tr>
				<tr>
       ...
       let msg = "";
	    ...
	    if(!check_pwd){
          ...
          return check;
           ...
           document.getElementById('mail-check-warn').innerText="비밀번호 인증을 해주세요";
