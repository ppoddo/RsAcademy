				...
				<div class="board_write_wrap">
					<div class="board_write">
						<div class="title">
							<dl>
								<dt>강의명</dt>
								<dd><input type="text" placeholder="강의명" name="clTitle" placeholder=""></dd>
							</dl>
							<br>
							<dl>
								<dt>강의 시작일</dt>
								<dd><input type="date" name="clStartdate" placeholder=""></dd>
							</dl>
							<br>
							<dl>
								<dt>강의 종료일</dt>
								<dd><input type="date" name="clEnddate" placeholder=""></dd>
							</dl>
							<br>
							<dl>
								<dt>레벨</dt>
							...
							<dl>
								<dt>강의소개</dt>
								<dd><textarea name="clIntro" placeholder=""></textarea></dd>
							</dl>
							<br>
							<dl>
								<dt>카테고리</dt>
