      ...
      <div class="enrol">
         ...
         <table class="table2">
            <tr>
               ...
               <td><input class="tableRadio" type="radio" name="mbIsAdmin" value="1">
                  <lable>개인회원 
                  </lable> <input class="tableRadio" type="radio"
                  name="mbIsAdmin" value="2">
                   <lable>강사 </lable> <input
                  class="tableRadio" type="radio" name="mbIsAdmin" value="3"> <lable>관리자
                  </lable></td>
            </tr>
            ...
            <tr>
               ...
               <td><input type="text" class="tableInput" id="id-check" name ="mbId"><span
                  id="id-check-warn"></span></td>
            </tr>
            <tr>
               <td class="tableLable"><lable>비밀번호 </lable></td>
               <td><input type="text" class="tableInput" id="pwd" name ="mbPwd"></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td>
                  <input class="tableInput" type="text" placeholder="우편번호" id="sample6_postcode" name="sample6_postcode"> 
                  <input type="button" id="sample6" onclick="sample6_execDaumPostcode()" class="tablebutton" value="검색"><br> 
                  <input type="text" class="tableInput" placeholder="기본주소" id="sample6_address" name="sample6_address"><br> 
                  <input type="text" class="tableInput" placeholder="나머지 주소(선택 입력 가능)" id="sample6_detailAddress" name="sample6_detailAddress"><br>
                  <input type="text" class="tableInput" id="sample6_extraAddress" placeholder="참고사항" name="sample6_extraAddress"></td>
            </tr>
            <tr>
               ...
               </select>- <input type="text" class="tableInput" name="tel2"> - <input
                  type="text" class="tableInput" name = "tel3"></td>
            </tr>
            <tr>
               <td class="tableLable"><label>이메일</label></td>
               <td><input class="tableInput" type="text"
                  placeholder="example@gmail.com" id="userEmail1" name="mbEmail"> <input
                  type="button" class="tablebutton" value="코드받기" id="mail-Check-Btn"><br>
                  <input class="tableInput mail-check-input" type="text"
       ...
       window.onload = () =>{
         ...
         checkId.addEventListener("blur",function () {
            ...
            if(checkId.value.trim() != ""){
               $.ajax({
                  type : 'get',
                  url : '${contextPath}/idCheck.jy', // GET방식이라 Url 뒤에 email을 뭍힐수있다.
